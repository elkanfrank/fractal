...
/*   Updated: 2019/05/16 16:21:51 by elkanfrank    ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
t_color	set_color(double n)
{
	...
	{
		color.red = ft_map(n, 0, MAX_ITER, 0x10, 0xF0);
		color.green = ft_map(n, 0, MAX_ITER, 0x10, 0xF4);
		color.blue = ft_map(n, 0, MAX_ITER, 0x10, 0xD3);
	}
	return (color);
}
